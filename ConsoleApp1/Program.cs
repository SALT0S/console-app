...
class Program
{
    ...
    public static async Task guardarEstudianteYdireccion()
    {
        ...
        await context.StudentAddresses.AddAsync(stdAddress);

        await context.SaveChangesAsync();

    }

    public static async Task guardarEstudianteYdireccionTransaction()
    {
        Console.WriteLine("Metodo agregar estudiante y direccion");
    ...
    public static async Task consultarEstudiantesFunciones()
    {
